...
public interface IFeature {
  ...
  // By convention, features use a single initial character to signify their type:
  ...
  */
  ...
  /**
     ...
     of the stateMessage when operating dynamically, then here disable
     whatever would cause consolidate to be unable to create an explicit
     feature:value representation of the feature(s) extracted this object.
  */
