...
/**
 * Extension of {@link java.util.Properties} that resolves substituted variables.
 * Example: given the following properties file:
 * 
 * my.foo = qux
 * my.bar = ${my.foo}/bar
 * 
...
public class JProperties extends Properties {
	 ...
	 * If substitution syntax is found, find the value to substitute (e.g., qux for my.foo),
	 * and replace the matched value in the properties (e.g., ${foo}/bar becomes qux/bar). 
	 */
